...
class Test:
    ...
    def xintiao(self):
        input_test_message.send_keys(f'''{"seq": {seq}, "src": {src}, "dst": {dst}, "cmd": "heartbeat", }''')  # 心跳信息测试
...
#
# button_web_link = driver.find_element(By.CLASS_NAME, 'btn,btn-success')  # websocket连接按钮
# button_send_message = driver.find_element(By.XPATH, '/html/body/div/div/div/div/div/div/form/div/span/button')  # 发送信息按钮
#
# input_address.send_keys('ws://221.178.225.58:9906/WebSocket')  # 输入服务器地址
# button_web_link.click()  # 点击连接按钮
